...
func SignedTransfer(sender *OnexAddress.Address, recipient *OnexAddress.Address, nonce uint64, amount *big.Int, payload []byte, gasLimit uint64, gasPrice *big.Int) (*action.Transfer, error) {
...
func SignedVote(voter *OnexAddress.Address, votee *OnexAddress.Address, nonce uint64, gasLimit uint64, gasPrice *big.Int) (*action.Vote, error) {
...
func SignedExecution(executor *OnexAddress.Address, contractAddr string, nonce uint64, amount *big.Int, gasLimit uint64, gasPrice *big.Int, data []byte) (*action.Execution, error) {
