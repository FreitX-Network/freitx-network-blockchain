...
import (
	...
	exp "github.com/freitx-project/freitx-network-blockchain/explorer"
...
func TestTwoChains(t *testing.T) {
	...
	cfg.Chain.ProducerPrivKey = "c0c08b8f4887c62a07d07388575e03d650cdcf1cf8050ba09881ea49ecb9746a4854ee01"
	cfg.Chain.ProducerPubKey = "5e24c6c19eb50a6da14d0d2841ee8b7f8e31771f31413466526f7a726f70d8a619421f066d2033c413cbaeb710de4056061c1ed728274cfaaa69a91436ec3fe2135d0e40e7fbae03"
	...
	require.NoError(t, testutil.WaitUntil(time.Second, 10*time.Second, func() (bool, error) {
		balanceStr, err := mainChainClient.GetAddressBalance(addr1.OnexAddress())
		if err != nil {
			return false, err
		}
	...
	details, err := mainChainClient.GetAddressDetails(addr1.OnexAddress())
	require.NoError(t, err)
	...
	details, err = subChainClient.GetAddressDetails(addr2.OnexAddress())
	var nonce uint64
	if err != nil {
		nonce = 1
	} else {
