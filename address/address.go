...
type Address interface {
	...
	Bytes() []byte
	// OnexAddress converts an address struct into an old address string
...
// OnexAddressToAddress converts an old address string into an address struct
// This method is used for backward compatibility
func OnexAddressToAddress(iotxRawAddr string) (Address, error) {
	return V1.OnexAddressToAddress(iotxRawAddr)
}
