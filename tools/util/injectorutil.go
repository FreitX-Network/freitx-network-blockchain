...
func LoadAddresses(keypairsPath string, chainID uint32) ([]*OnexAddress.Address, error) {
...
func InitCounter(client explorer.Explorer, addrs []*OnexAddress.Address) (map[string]uint64, error) {
...
func InjectByAps(
	...
	admins []*OnexAddress.Address,
	delegates []*OnexAddress.Address,
...
func injectTransfer(
	wg *sync.WaitGroup,
	c explorer.Explorer,
	sender *OnexAddress.Address,
	recipient *OnexAddress.Address,
	nonce uint64,
	gasLimit uint64,
	gasPrice *big.Int,
	payload string,
...
func createTransferInjection(
	counter map[string]uint64,
	addrs []*OnexAddress.Address,
) (*OnexAddress.Address, *OnexAddress.Address, uint64) {
...
func createSignedVote(
	voter *OnexAddress.Address,
	votee *OnexAddress.Address,
	nonce uint64,
	gasLimit uint64,
	gasPrice *big.Int,
) (*action.Vote, error) {
