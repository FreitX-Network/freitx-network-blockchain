...
import (
	...
	blockchain "github.com/freitx-project/freitx-network-blockchain/blockchain"
	OnexAddress "github.com/freitx-project/freitx-network-blockchain/onexaddress"
...
func (m *MockBlockchain) MintNewBlock(actions []action.Action, producer *OnexAddress.Address, dkgAddress *OnexAddress.DKGAddress, seed []byte, data string) (*blockchain.Block, error) {
...
func (m *MockBlockchain) MintNewSecretBlock(secretProposals []*action.SecretProposal, secretWitness *action.SecretWitness, producer *OnexAddress.Address) (*blockchain.Block, error) {
