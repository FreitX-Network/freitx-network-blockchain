...
func putBlockToParentChain(rootChainAPI explorerapi.Explorer, subChainAddr string, sender *OnexAddress.Address, b *blockchain.Block) {
...
func putBlockToParentChainTask(rootChainAPI explorerapi.Explorer, subChainAddr string, sender *OnexAddress.Address, b *blockchain.Block) error {
...
func constructPutSubChainBlockRequest(rootChainAPI explorerapi.Explorer, subChainAddr string, sender *OnexAddress.Address, b *blockchain.Block) (explorerapi.PutSubChainBlockRequest, error) {
	// get sender address on mainchain
	subChainAddrSt, err := address.OnexAddressToAddress(subChainAddr)
	if err != nil {
	...
	senderPCAddr := address.New(parentChainID, senderPKHash[:]).OnexAddress()
