...
var testAddrs = []*OnexAddress.Address{
	newTestAddr(),
	newTestAddr(),
	newTestAddr(),
	newTestAddr(),
...
func newTestCFSM(
	...
	vote, err := action.NewVote(2, address.OnexAddress(), address.OnexAddress(), uint64(100000), big.NewInt(10))
	require.NoError(t, err)
...
func test21Addrs() []*OnexAddress.Address {
